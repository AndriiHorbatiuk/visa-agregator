 ...
 */
public class ComparatorByTAStreetNameAlphabet implements Comparator<String> {
    public int compare(String o1, String o2) {
        ...
        return AllTravelAgenciesData.ALL_TRAVEL_AGENCIES_DATA.getFromDB(travelAgencyId1).getTravelAgencyStreet().compareTo(
